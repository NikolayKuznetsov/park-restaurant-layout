...
function resetReservation() {
    ...
    $('.reservation-form').velocity({opacity: 0}, {
        display: 'none', complete: function () {
            ...
            if (dateReplace === '') {
                ...
                $('.home-2 .home-content .second-line, .home-2 .home-content .second-border').velocity({
                    translateY: '0px',
                    opacity: 1,
                    blur: '0px'
                }, {duration: 700, easing: 'easeOutCubic', display: 'inline-block'});
            }
        }
    });
}
...
function homeBackReservation() {
    ...
    $('.home-2 .home-content .first-line').velocity({
        ...
        $('.home-2 .home-content .first-line').text($('.home-2 .home-content .first-line').data('base'));
        $('.home-2 .home-content .first-line').delay(300).velocity({
            translateY: '0px',
            opacity: 1,
            blur: '0px'
        }, 700, 'easeOutCubic', function () {
    ...
    $('.home-2 .home-content .second-line, .home-2 .home-content .second-border').velocity({
        ...
        if (dateReplace === '') {
            ...
            $('.home-2 .home-content .second-line').text(dateReplace);
            $('.home-2 .home-content .second-line, .home-2 .home-content .second-border').delay(300).velocity({
                translateY: '0px',
                opacity: 1,
                blur: '0px'
            }, {
                duration: 700, easing: 'easeOutCubic', display: 'inline-block', complete: function () {
                }
            });
        }
    });
...
$(document).ready(function () {
    ...
    if ($('body').hasClass('page-template-homepage2')) {
        ...
        $('.button-text').hover(function () {
            ...
            $('.button-frame-hover').velocity('stop').velocity({
                translateX: '10px',
                translateY: '10px',
                opacity: 1
            }, 300);
        ...
        $('#reservation-trigger').click(function () {
            ...
            $('.home-2 .home-content .first-line').velocity('stop').velocity({
                translateY: '-30px',
                opacity: 0,
                blur: '3px'
            }, 700, 'easeOutCubic');
            $('.home-2 .home-content .second-line, .home-2 .home-content .second-border').velocity('stop').velocity({
                translateY: '30px',
                opacity: 0,
                blur: '3px'
            }, 700, 'easeOutCubic');
        ...
        $('.datepicker-submit .form-next-step').click(function () {
            $('.reservation-form-1').velocity({translateX: '-100%', opacity: 0}, 1500, 'easeOutQuint', function () {
                $(this).hide(0);
            });
        ...
        $('.timepicker-submit .form-next-step').click(function () {
            $('.reservation-form-2').velocity({translateX: '-100%', opacity: 0}, 1500, 'easeOutQuint', function () {
                $(this).hide(0);
            });
    ...
    open: function (id) {
        ...
        $.post(url, {action: 'berg_load_single_portfolio', data: {'id': id}}, function (response) {
            ...
            $('.berg-overlay-background').velocity({opacity: 1}, {
                display: "block", duration: 0, complete: function () {
                    // that.resize();
        ...
        $('.flyout-container .menu-item .open-children, .flyout-container .menu-item a').on('click', function (e) {
            ...
            if ($(this).siblings('.subnav-wrapper').length > 0) {
                ...
                if ($(this).siblings('.subnav-wrapper').hasClass('open')) {
                    ...
                    $(this).siblings('.subnav-wrapper').velocity({height: 0}, {
                        complete: function () {
                    ...
                    $(this).siblings('.subnav-wrapper').velocity({height: $(this).siblings('.subnav-wrapper').children('li').height() * $(this).siblings('.subnav-wrapper').children('li').length}, {
                        complete: function () {
...
var gallery = {
    ...
    loadMore: function () {
        ...
        $.post(url, {
            ...
            if ($('.no-more-posts').length > 0) {
                ...
                $('.load-more-text').delay(400).velocity('fadeIn', {
    ...
    loadMoreMasonry: function () {
        ...
        $.post(url, {
            action: 'berg_load_more_portfolio_masonry',
            data: {'pageId': pageId, 'page': that.page, 'layout': $('#gallery2 .load-page-counter').data('nextLayout')}
        }, function (response) {
...
var blog = {
    ...
    loadMoreMasonry: function (nextPage, layoutIndex, maxPages) {
        ...
        $.post(url, {
            action: 'berg_load_more_posts_masonry',
            data: {
                'pageId': pageId,
                'page': that.page,
                'customLayout': $('#blog-new-masonry').data('customLayout'),
                'layout': $('.blog-masonry .load-page-counter').data('nextLayout')
            }
        }, function (response) {
    ...
    init: function () {
        ...
        $('.show-map-btn').on('click', function (e) {
            ...
            if ($('.show-map-btn').hasClass('non-active-map')) {
                $that.parents('.section-intro').find('.bg-section').velocity({opacity: 1}, {
                    complete: function () {
                ...
                $that.parents('.section-intro').find('.pre-content').velocity({opacity: 0}, {
                    display: 'table-cell',
                    visibility: 'hidden'
                });
            } else {
                $that.parents('.section-intro').find('.bg-section').velocity({opacity: dataOpacity}, {
                    complete: function () {
                ...
                $that.parents('.section-intro').find('.pre-content').velocity({opacity: 1}, {
                    display: 'table-cell',
                    visibility: 'visible'
                });
            }
